 ...
 *
function membershipperiodtracker_civicrm_preProcess($formName, &$form) {
 ...
 *
function membershipperiodtracker_civicrm_navigationMenu(&$menu) {
  _membershipperiodtracker_civix_insert_navigation_menu($menu, NULL, array(
    'label' => E::ts('The Page'),
    'name' => 'the_page',
  ...
  _membershipperiodtracker_civix_navigationMenu($menu);
} // */
